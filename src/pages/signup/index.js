...
function Signup() {
  ...
  function validateEmail(email) {
    const emailPattern = /@sitpune\.edu\.in$/i;
  ...
  const handleEmailChange = (event) => {
    ...
    // Update validation state based on validation result
  ...
  const handleSendotp = () => {
    ...
    if (validateEmail(email)) {
      ...
      setVariant("danger")
      setAlertMessage("Please enter organization associated email")
            ...
            <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
              ...
              {showemail && (
                <div>
                  ...
                  {!isValid && (
                    <p style={{ "color": "red" }}>Please Enter institution associated email address</p>
                  )}
                  {isValid && (
